...
def arg_parser():
    ...
    # parser.add_argument('--TF', type=str, required=True, nargs=2, choices=['ARID3A', 'CTCFL', 'ELK1', 'FOXA1', 'GABPA', 'MYC', 'REST', 'SP1', 'USF1', 'ZBTB7A'], help='choose one from [ARID3A / CTCFL / ELK1 / FOXA1 / GABPA / MYC / REST / SP1 / USF1 / ZBTB7A]')
...
def main():
    ...
    tf1_train_data_loader, tf1_valid_data_lodaer, tf1_all_train_data_lodaer = dataset_loader(tf1_train_dataset_path, batch_size, reverse_mode)
    ...
    tf2_train_data_loader, tf2_valid_data_lodaer, tf2_all_train_data_lodaer = dataset_loader(tf2_train_dataset_path, batch_size, reverse_mode)
